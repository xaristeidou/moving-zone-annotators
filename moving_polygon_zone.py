...
# random initial coordinates for points array 
points = np.array([[0,0],
         [400,0],
         [400,350],
         [0,350]])

# calculation of x,y center coordinates 
point = find_center_coordinates(points=points)
...
while cap.isOpened():
    ...
    if success:
        ...
        zone = sv.PolygonZone(polygon=points, frame_resolution_wh=(frame.shape[1], frame.shape[0]))
        ...
        # plot zone annotator
        zone_annotator.annotate(annotated_frame)
